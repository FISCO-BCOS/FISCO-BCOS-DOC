...
.. admonition:: 概览
    ...
    - 深入了解FISCO BCOS 2.0+功能请看 `配置文件和配置项 <./docs/blockchain_dev/configuration.html>`_、`节点准入 <./docs/manual/node_management.html>`_、`并行交易 <./docs/manual/transaction_parallel.html>`_、`分布式存储 <./docs/manual/distributed_storage.html>`_、`国密 <./docs/blockchain_dev/guomi_crypto.html>`_ 等请参考 `使用手册 <./docs/manual/index.html>`_
