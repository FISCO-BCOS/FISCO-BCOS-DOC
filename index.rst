...
.. admonition:: 概览
    ...
    - `Web3SDK <./docs/sdk/sdk.html>`_：提供访问节点、查询节点状态、修改区块链系统配置以及向节点发送交易等接口。
    - JSON-RPC接口可参考 `JSON-RPC API <./docs/api.html>`_
    - 系统设计文档请参考 `系统设计 <./docs/design/index.html>`_

.. admonition:: 关键特性

    - `多群组 <./docs/design/architecture/group.html>`_: `教程 <./docs/tutorial/group_use_cases.html>`_ ，`使用说明 <./docs/manual/configuration.html>`_
    - `并行计算 <./docs/design/parallel/dag.html>`_: `使用说明 <./docs/manual/transaction_parallel.html>`_
    - `分布式存储 <./docs/design/storage/index.html>`_: `使用说明 <./docs/manual/amdbconfig.html>`_
