...
.. admonition:: 关键特性
    ...
    - `分布式存储 <./docs/design/storage/index.html>`_: `使用手册 <./docs/manual/distributed_storage.html>`_
=======
.. admonition:: 概览
...
<<<<<<< HEAD
    ...
    - 深入了解FISCO BCOS 2.0的 `源码编译 <./docs/manual/get_executable.html#id2>`_、`建链脚本 <./docs/manual/build_chain.html>`_、`配置文件和配置项 <./docs/manual/configuration.html>`_、`控制台 <./docs/manual/console.html>`_、`节点准入 <./docs/manual/node_management.html>`_、`并行交易 <./docs/manual/transaction_parallel.html>`_、`分布式存储 <./docs/manual/.html>`_、`国密 <./docs/manual/guomi_crypto.html>`_ 等请参考 `使用手册 <./docs/manual/index.html>`_
