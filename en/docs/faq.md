...
A:
  ...
  - FISCO BCOS version 2.0 provides a console to help users quickly understand how to use FISCO BCOS. For the detail, Please refer to [here](./manual/console_with_java_sdk.md) for the console user manual of version 2.0 and above, and [here](./manual/console.md) for the console user manual of version 1.x
