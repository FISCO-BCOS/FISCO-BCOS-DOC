...
.. important::
    ...
    - For 1.x version console documentation, please refer to `here <./manual/console.html>`_ , for 2.0 and above version console documentation please refer to `here <./manual/console_with_java_sdk.html>`_
    - You can view the current console version through the command ``./start.sh --version``
```

Console links nodes of FISCO BCOS through Web3SDK so as to realize functions like blockchain status query, call and deploy contracts. 1.x version console command detailed introduction [refer here](manual/console.md), 2.0 version console command detailed introduction [refer here](manual/console_with_java_sdk.md).
