...
Please refer to [here](./console_with_java_sdk.md) for the console manual for version 2.0 and above, and [here](./console.md) for the console manual for version 1.x. Here we use console as an example.
