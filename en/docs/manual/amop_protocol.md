...
- Security: All communication links of AMOP use SSL encryption. The encryption algorithm is configurablem,and the topic supports identity authentication mechanism.
