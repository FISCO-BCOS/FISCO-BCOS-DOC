...
- console commands: Please refer to [here](../manual/console_with_java_sdk.md) for the console user manual of version 2.0 and above, and [here](../manual/console.md) for the console user manual of version 1.x
