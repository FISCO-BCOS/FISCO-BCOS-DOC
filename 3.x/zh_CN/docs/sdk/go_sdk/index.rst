...
`Go SDK <https://github.com/FISCO-BCOS/go-sdk>`_ 提供了访问 `FISCO BCOS <https://github.com/FISCO-BCOS/FISCO-BCOS>`_ 节点的Go API，支持节点状态查询、部署和调用合约等功能，基于Go SDK可快速开发区块链应用，目前支持FISCO BCOS v2.2.0+与v3.3.0+

.. admonition:: **主要特性**

    - 提供调用FISCO BCOS `JSON-RPC <../../develop/api.html>`_ 的Go API
