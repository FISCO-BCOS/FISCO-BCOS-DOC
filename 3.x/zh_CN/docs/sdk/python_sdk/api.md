...
- Python API：封装了访问FISCO BCOS 2.0+节点[JSON-RPC](../../develop/api.md)的Python API
...
实现于`client/bcosclient.py`，封装了访问FISCO BCOS 2.0+节点[JSON-RPC](../../develop/api.md)的Python API，主要接口包括：
