...
Pro版本FISCO BCOS区块链系统支持动态多群组区块链网络，可在系统运行时扩容产生新群组、下线群组。`BcosBuilder`
提供了新群组上线和下线功能，本章在[搭建Pro版区块链网络](./installation.md)的基础上扩容、下线群组`group2`，帮助用户掌握Pro版本FISCO
BCOS区块链系统群组扩容、下线步骤。
...
新群组部署成功后，可使用控制台直接连接新群组`group2`，向新群组发送交易。
