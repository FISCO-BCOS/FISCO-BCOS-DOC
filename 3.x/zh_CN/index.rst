...
FISCO BCOS（读作/ˈfɪskl bi:ˈkɒz/）是金链盟开源工作组于2017年推出的国产安全可控区块链底层开源平台，致力于为数字经济时代提供可信基础设施，其可用性经广泛应用实践检验。至今已在金融、政务、公益等领域落地标杆应用超600个，有效助力产业数字化发展和数据可信流通。
