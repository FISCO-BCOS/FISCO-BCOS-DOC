...
As you can see, this test deployment uses' v1.0.0-rc3 'version of Enterprise Deployment Tools,' 2.0.0-rc3 gm 'version of FISCO BCOS(Seems to be the same as the deployment process for the rc2 version)。
