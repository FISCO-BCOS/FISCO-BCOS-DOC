...
[The sparrow is small and has all five internal organs| Talk about FISCO BCOS Multilingual SDK from Python-SDK](https://mp.weixin.qq.com/s/YZdqf3Wxsnj8hY2770CuQA)This article explains in detail how to understand the block link port from the client's application。
