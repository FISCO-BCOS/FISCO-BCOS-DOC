...
-webankblockchain-liquid (hereinafter referred to as WBC-Liquid) contract can be used by declaring the interface of Table before implementing the contract。
