...
Tag: "java-sdk "" send transaction "" external signature "" assembly transaction "" contract invocation ""
...
The console provides a specialized tool for compiling contracts that allows developers to integrate Solidity / webankblockchain-liquid (hereinafter referred to as WBC-Liquid) contract file compilation to generate Java files and abi, binary files, the specific use of [reference here](./quick_start.html#contract2java-sh)。
