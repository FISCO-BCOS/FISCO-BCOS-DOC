...
3. 将配置文件config-example.toml, 存放在应用的主目录下。
   ...
   * config-example.toml可以在java-sdk [GitHub链接](https://github.com/FISCO-BCOS/java-sdk/blob/master-2.0/src/test/resources/config-example.toml)或[Gitee链接](https://gitee.com/FISCO-BCOS/java-sdk/blob/master-2.0/src/test/resources/config-example.toml)的源文件以下位置找到：`src/test/resources/config-example.toml`
