...
----
`Node.js SDK <https://github.com/FISCO-BCOS/nodejs-sdk>`_ 提供了访问 `FISCO BCOS <https://github.com/FISCO-BCOS/FISCO-BCOS/tree/master-2.0>`_ 节点的Node.js API，支持节点状态查询、部署和调用合约等功能，基于Node.js SDK可快速开发区块链应用，目前支持 `FISCO BCOS 2.0+  <../../../>`_ 
