...
- [HelloWorld合约](https://github.com/FISCO-BCOS/spring-boot-starter/blob/https://github.com/FISCO-BCOS/spring-boot-starter/src/test/resources/contract/HelloWorld.sol)
