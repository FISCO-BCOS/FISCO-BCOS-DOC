...
# 获取控制台
curl -#LO https://github.com/FISCO-BCOS/console/releases/download/v2.8.1/download_console.sh && bash download_console.sh
```
...
```bash	
# 0.5	
curl -#LO https://github.com/FISCO-BCOS/console/releases/download/v2.8.1/download_console.sh && bash download_console.sh -v 0.5	
# 0.6	
curl -#LO https://github.com/FISCO-BCOS/console/releases/download/v2.8.1/download_console.sh && bash download_console.sh -v 0.6	
```

```eval_rst
.. note::
    - 如果因为网络问题导致长时间无法下载，0.5版本请尝试命令： `https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/FISCO-BCOS/console/releases/v2.8.1/download_console.sh && bash download_console.sh -v 0.5` 
    0.6版本请尝试命令： `https://osp-1257653870.cos.ap-guangzhou.myqcloud.com/FISCO-BCOS/console/releases/v2.8.1/download_console.sh && bash download_console.sh -v 0.6`
