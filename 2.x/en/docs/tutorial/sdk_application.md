...
```eval_rst
.. note::
    - If the asset-app.tar.gz cannot be downloaded for a long time due to network problems, try `curl -#LO https://gitee.com/FISCO-BCOS/console/raw/master/tools/asset-app.tar.gz`
```
