...
``` shell
$ ls ./nodes_cert
cert_127.0.0.1_30300.crt  cert_127.0.0.1_30301.crt  peers.txt # 节点0证书 节点1证书 节点P2P连接地址列表
```
...
按照网络拓扑，汇总**所有组员**节点**P2P端口**的地址，排除自己，生成peers文件
...
按照网络拓扑，汇总**所有组员**节点**P2P端口**的地址，排除自己，生成peers文件，组2的配置与组1有不同
