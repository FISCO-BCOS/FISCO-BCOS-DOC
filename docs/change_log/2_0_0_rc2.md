# [FISCO BCOS v2.0.0-rc2](https://github.com/FISCO-BCOS/FISCO-BCOS/releases/tag/v2.0.0-rc2)

```eval_rst
.. admonition:: v2.0.0-rc1升级到v2.0.0-rc2

    - **兼容升级** ：直接替换v2.0.0-rc1节点的二进制为v2.0.0-rc2二进制，升级后的版本修复v2.0.0-rc1中的bug，但不会启用v2.0.0-rc2并行计算、分布式存储等新特性， **升级到v2.0.0-rc2后，无法回滚到v2.0.0-rc1**
...
| 控制台    | v1.0.2+                                              |                                                              |
| Web3SDK   | v2.0.0-rc2+                                          |                                                              |
| Generator | v1.0.0-rc2                                     | 仅可使用v1.0.0-rc2                                |
| 浏览器    | v2.0.0-rc2+                                          |                                                              |
