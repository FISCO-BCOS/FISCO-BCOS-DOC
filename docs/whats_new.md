...
更多的群组介绍，请参考![群组架构设计文档](./design/group.md)和![群组功能使用文档](./manual/groups/index.html)
...
另外，还有类似CRUD操作等也由预编译合约实现，更多预编译合约的介绍，请参考![预编译设计文档](./design/virtualMachine/precompiled.md)和![预编译合约开发文档](./design/developer/precompiled.md)
