...
app         311  0.9  0.0 986644  7184 pts/0    Sl   15:21   0:00 /home/fisco/nodes/127.0.0.1/node7/../fisco-bcos -c config.ini
app      131048  2.1  0.0 1429036 7452 pts/0    Sl   15:21   0:00 /home/fisco/nodes/127.0.0.1/node0/../fisco-bcos -c config.ini
app      131053  2.1  0.0 1429032 7180 pts/0    Sl   15:21   0:00 /home/fisco/nodes/127.0.0.1/node1/../fisco-bcos -c config.ini
app      131058  0.8  0.0 986644  7928 pts/0    Sl   15:21   0:00 /home/fisco/nodes/127.0.0.1/node2/../fisco-bcos -c config.ini
app      131063  0.8  0.0 986644  7452 pts/0    Sl   15:21   0:00 /home/fisco/nodes/127.0.0.1/node3/../fisco-bcos -c config.ini
app      131068  0.8  0.0 986644  7672 pts/0    Sl   15:21   0:00 /home/fisco/nodes/127.0.0.1/node4/../fisco-bcos -c config.ini
...
# 查看node0 group3是否正常共识
$ tail -f node0/log/* | grep "g:3.*++"
info|2019-02-11 15:33:51.022444| [g:3][p:776][CONSENSUS][SEALER]++++++++Generating seal on,blkNum=1,tx=0,nodeIdx=3,hash=2c455288...

# ... 查看node1和node2的所有群组是否正常可参考node0操作方法...
...
info|2019-02-11 15:39:58.994218| [g:3][p:776][CONSENSUS][SEALER]++++++++Generating seal on,blkNum=1,tx=0,nodeIdx=2,hash=eb5801bf...
```

### 向群组发交易

`build_chain`提供了`transTest.sh`脚本，可向指定群组发交易，本例中脚本位于`~/fisco/nodes/127.0.0.1`目录下，该脚本使用方法：
...
info|2019-02-11 18:53:20.708366| [g:2][p:520][CONSENSUS][PBFT]^^^^^Report:,num=9,sealerIdx=3,hash=80c98d31...,next=10,tx=1,nodeIdx=1
......此处省略其他输出......
```
