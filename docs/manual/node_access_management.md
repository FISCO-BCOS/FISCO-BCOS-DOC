...
3. 重启节点3；
4. 确认节点3与节点1和节点2的连接已经建立，加入网络操作完成。
...
判断一节点是否与他节点建立连接的方法：
```
# 在打开DEBUG级别日志前提下，查看自身节点（node0）连接的节点数及所连接的节点信息（nodeID）
# 以下日志表明节点node0与三个节点（节点的nodeID前4个字节为d74abfe0、58f16de9、b83cf46e）建立了连接
$ tail -f node0/log/log*  | grep P2P
debug|2019-02-21 10:30:18.694258| [P2P][Service] heartBeat ignore connected,endpoint=127.0.0.1:30401,nodeID=d74abfe0...
debug|2019-02-21 10:30:18.694277| [P2P][Service] heartBeat ignore connected,endpoint=127.0.0.1:30402,nodeID=58f16de9...
debug|2019-02-21 10:30:18.694287| [P2P][Service] heartBeat ignore connected,endpoint=127.0.0.1:30403,nodeID=b83cf46e...
info|2019-02-21 10:30:18.694294| [P2P][Service] heartBeat connected count,size=3
```
