...
|     | 节点4 | 群组1、2  | 127.0.0.1:30304 | 127.0.0.1:8549/:20204 |
| 机构B | 节点2 | 群组1   | 127.0.0.1:30302 | 127.0.0.1:8547/:20202 |
|     | 节点3 | 群组1   | 127.0.0.1:30303  | 127.0.0.1:8548/:20203 |
| 机构C | 节点5 | 群组1、2   | 127.0.0.1:30305 | 127.0.0.1:8550/:20205 |

```eval_rst
.. important::

    针对云服务器中的vps服务器，RPC监听地址需要写网卡中的真实地址(如内网地址或127.0.0.1)，可能与用户登录的ssh服务器不一致。
    备注：这里是在实际生产环境中有争议点的地方，p2p地址是要填写公网地址，rpc 监听地址填写内网地址，前提要保证各个节点都可以ping的通。
```
